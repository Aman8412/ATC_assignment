...
public class UserLogin {
	...
	public static void main(String[] args) {
		...
		System.setProperty("webdriver.chrome.driver","C:\\Users\\h\\Downloads\\chromedriver_win32\\chromedriver.exe");
		  ...
		  //Enter email address
		  driver.findElement(By.id("email_create")).sendKeys("test789@ctest.com");
		  ...
		  driver.findElement(By.name("customer_firstname")).sendKeys("Michelle");
		  driver.findElement(By.name("customer_lastname")).sendKeys("Croft");
		  driver.findElement(By.id("passwd")).sendKeys("Pass@123");
		  
		  // Enter your address
		  driver.findElement(By.id("firstname")).sendKeys("Michelle");
		  driver.findElement(By.id("lastname")).sendKeys("Croft");
